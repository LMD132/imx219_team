...
`define DBG_MODULE_UUID _6b2cfb2ef5454b6192fd38d027043c0f
...
module debug_edb_top (
    ...
    output bscan_TDO,
    input  vio0_clk,
    output [15:0] vio0_r_gain,
    output [15:0] vio0_g_gain,
    output [15:0] vio0_b_gain,
    output vio0_gamma_sel,
    input  la0_clk,
    input  [7:0] la0_ch0_g,
    input  [7:0] la0_ch0_b,
    input  la0_ch0_de,
    ...
    `DBG_MODULE_NAME(edb_vio_top) #(
        .NUM_PROBE_IN           ( 0 ),
        .NUM_PROBE_OUT          ( 4 ),
        .UUID           ( 128'hd2d3643a7f1e49a3a7f48b242e104fdd ),
        .PROBE_OUT0_WIDTH       ( 16 ),
        .PROBE_OUT1_WIDTH       ( 16 ),
        .PROBE_OUT2_WIDTH       ( 16 ),
        .PROBE_OUT3_WIDTH       ( 1 ),
        .PROBE_OUT0_INIT_VAL    ( 'h118 ),
        .PROBE_OUT1_INIT_VAL    ( 'hff ),
        .PROBE_OUT2_INIT_VAL    ( 'h15e ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio0_r_gain ),
        .probe_out1         ( vio0_g_gain ),
        .probe_out2         ( vio0_b_gain ),
        .probe_out3         ( vio0_gamma_sel ),
        .probe_out4         (  ),
        .probe_out5         (  ),
        .probe_out6         (  ),
        .probe_out7         (  ),
    ...
    `DBG_MODULE_NAME(edb_la_top) #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h40fc40c15a7b4e5392113defb86d2a4c ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 8 ),
...
//
module `DBG_MODULE_NAME(edb_vio_top) #(
...
//
module `DBG_MODULE_NAME(vio_core) #(
    ...
    output reg [(OUT_WIDTH ? OUT_WIDTH-1 : 0):0] probe_out_vec = PROBE_OUT_INIT_VAL
);
    // RTL version
    ...
    always @(*) begin
        case (internal_register_select)
            ...
            INTREG_VERSION: begin
                data_from_internal_reg = { MINOR_VERSION, MAJOR_VERSION };
            end
    ...
    generate
        for (i = 0; i < INT_WIDTH; i = i + 1) begin : gen_probe_in_sync
            `DBG_MODULE_NAME(syncer) sync_probe_in_U (
                .CLKA ( bscan_TCK ), 
                .RSTA ( 1'b0 ),
                .DA   ( probe_in_vec[i] ), 
                .ENA  ( ~hold_probe_in ),
